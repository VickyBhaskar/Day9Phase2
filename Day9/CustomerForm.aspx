﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerForm.aspx.cs" Inherits="Day9.CustomerForm" %>
...
&nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="TxtPwd" ErrorMessage="CompareValidator" ForeColor="Red" ValueToCompare="Vicky@345"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
